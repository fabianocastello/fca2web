...
def run():
    ...
    with st.expander("Considerações sobre formatos de arquivos e campos de data"):
           ...
           st.write("""
               A partir de setembro de 2021 implementei análise de colunas datetime. Estava fazendo falta e agora está bem completo. No entanto, são raras as situações onde o pandas detecta colunas datetime de forma automática (qualquer mínimo desvio ele vai enxergar como object) Para arquivos CSV nem adianta tentar... Em excel vai bem, e com pickle e feather também. Em tempo, existe uma análise chamada "filling", que considera o range de dias, meses e anos e informa, de todo o range, em qual "slots"há dado presente.""")
